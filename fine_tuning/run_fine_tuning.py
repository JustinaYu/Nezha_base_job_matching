...
def main():
    ...
    parser.add_argument('--init_nezha_ckpt', type=str, default="fine_tuning/finetuning_model/checkpoints/500.0-ckpt-20241129_114655.pt", help='the ckpt file from the pretraining stage.')
